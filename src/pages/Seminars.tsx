  ...
  return (
    <div className="prose dark:prose-invert max-w-none">
      ...
      <ul className="text-[13px] space-y-2 list-none">
        <li className="before:content-['(Spring 2026)'] before:inline-block before:w-12 before:text-right before:mr-4 before:font-mono">
          (Spring 2025) Harvard/MIT Babytop Seminar --- Trace methods II, joint w/ Logan Hyslop
        </li>
        <li className="before:content-['(Fall 2025)'] before:inline-block before:w-12 before:text-right before:mr-4 before:font-mono">
        ...
        <li className="before:content-['(Spring 2025)'] before:inline-block before:w-12 before:text-right before:mr-4 before:font-mono">
        ...
        <li className="before:content-['(Summer 2022)'] before:inline-block before:w-12 before:text-right before:mr-4 before:font-mono">
